/*** Autogenerated by WIDL 1.6 from d2d1.idl - Do not edit ***/
...
static FORCEINLINE D2D1_SIZE_U ID2D1Bitmap_GetPixelSize(ID2D1Bitmap* This) {
    return This->lpVtbl->GetPixelSize(This);
}
